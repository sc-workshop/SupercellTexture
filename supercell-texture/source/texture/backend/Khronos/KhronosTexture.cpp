...
#pragma region Static Functions
    Image::PixelDepth KhronosTexture::format_depth(glInternalFormat format) {
        switch (format) {
            case glInternalFormat::RGBA8:
                return PixelDepth::RGBA8;
            case glInternalFormat::RGB8:
                return PixelDepth::RGB8;
            case glInternalFormat::LUMINANCE8:
                return PixelDepth::LUMINANCE8;
            case glInternalFormat::LUMINANCE8_ALPHA8:
                return PixelDepth::LUMINANCE8_ALPHA8;

            case glInternalFormat::COMPRESSED_RGBA_ASTC_4x4:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_5x4:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_5x5:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_6x5:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_6x6:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_8x5:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_8x6:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_8x8:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_10x5:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_10x6:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_10x8:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_10x10:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_12x10:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_12x12:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_4x4:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_5x4:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_5x5:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_6x5:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_6x6:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_8x5:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_8x6:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_8x8:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_10x5:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_10x6:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_10x8:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_10x10:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_12x10:
            case glInternalFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_12x12:
                return PixelDepth::RGBA8;
    ...
    Image::ColorSpace KhronosTexture::format_colorspace(glFormat format, glInternalFormat internal) {
        switch (internal) {
            case glInternalFormat::COMPRESSED_RGBA_ASTC_4x4:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_5x4:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_5x5:
    ...
    glFormat KhronosTexture::type(glInternalFormat format) {
        switch (format) {
            case glInternalFormat::COMPRESSED_RGBA_ASTC_4x4:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_5x4:
            case glInternalFormat::COMPRESSED_RGBA_ASTC_5x5:
            ...
            case glInternalFormat::RGB8:
                return glFormat::RGB;
            case glInternalFormat::LUMINANCE8:
                return glFormat::LUMINANCE;
            case glInternalFormat::LUMINANCE8_ALPHA8:
                return glFormat::LUMINANCE_ALPHA;
...
#pragma endregion ASTC Compression
    ...
    size_t KhronosTexture::decompressed_data_length(uint32_t level_index) {
        return Image::calculate_image_length(m_width / (uint16_t) (pow(2, level_index)),
    ...
    void KhronosTexture::decompress_data(Stream& output, uint32_t level_index) {
        if (level_index >= m_levels.size())
            level_index = static_cast<uint32_t>(m_levels.size()) - 1;
    ...
    void KhronosTexture::set_level_data(Stream& stream, Image::PixelDepth source_depth, uint32_t level_index) {
        ...
        if (source_depth != destination_depth) {
            temp_buffer.resize(Image::calculate_image_length(m_width, m_height, destination_depth));

            Image::remap((uint8_t*) stream.data(),
        ...
        SharedMemoryStream input_image(use_temp_buffer ? (uint8_t*) temp_buffer.data() : (uint8_t*) stream.data(),
        ...
        switch (compression_type()) {
            ...
            default:
                ...
                Memory::copy(input_image.data(), buffer->data(), input_image.length());
                break;
        }
